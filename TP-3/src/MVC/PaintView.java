...
public class PaintView extends JFrame implements Observer, MouseWheelListener, MouseListener, MouseMotionListener {
	...
	private JMenuItem menuItemListeCommandes = new JMenuItem("Liste des commandes effectuées");
	...
	public PaintView(PaintControler control, PaintModel model) {
		...
		menuItemListeCommandes.addActionListener(new ListeCommandesListener());
	...
	private void createMenuBar() {
		...
		menuAction.add(menuItemListeCommandes);
		setJMenuBar(menuBar);
		...
		menuItemListeCommandes.setEnabled(false);
	}
